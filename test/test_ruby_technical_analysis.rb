...
class TestRubyTechnicalAnalysis < Minitest::Test
  ...
  def test_chaikin_money_flow
    ...
    assert_equal RTA::ChaikinMoneyFlow.new(hlcv_series_one, 5).call.truncate(5), 0.50786
    assert_equal RTA::ChaikinMoneyFlow.new(hlcv_series_two, 5).call.truncate(5), 0.22763
  end
  ...
  def test_mass_index
    ...
    assert_equal RTA::MassIndex.new(hl_series_one, 9).call, 3.2236
    assert_equal RTA::MassIndex.new(hl_series_two, 9).call, 3.1387
  end
  ...
  def test_q_stick
    ...
    assert_equal RTA::QStick.new(oc_series_one, 4).call, 0.7969
    assert_equal RTA::QStick.new(oc_series_two, 4).call, 0.4688
  end
  ...
  def test_relative_momentum_index
    series_one = [6.8750, 6.9375, 6.8125, 6.6095, 6.7345, 6.6720, 6.6250, 6.6875, 6.5470, 6.6563, 6.6720, 6.6563]
    series_two = [6.8750, 6.9375, 6.8125, 6.6095, 6.7345, 6.6720, 6.6250, 6.6875, 6.5470, 6.6563, 6.6720, 6.6563, 6.5938]
