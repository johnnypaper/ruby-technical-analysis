...
class TestRubyTechnicalAnalysis < Minitest::Test
  ...
  def test_envelopes_ema
    ...
    assert_equal case_one.envelopes_ema(5, 20), [29.637, 24.698, 19.758]
    assert_equal case_two.envelopes_ema(5, 20), [29.588, 24.657, 19.725]
  end
  ...
  def test_price_channel
    ...
    assert_equal case_one.price_channel(5), [2.9740, 2.8127]
    assert_equal case_two.price_channel(5), [3.0730, 2.8127]
  end
