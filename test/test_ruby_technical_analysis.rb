...
class TestRubyTechnicalAnalysis < Minitest::Test
  def test_mean
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0, 1, 2, 3]).mean, 1.5
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([-1, 1, 2, -2]).mean, 0
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0, 0]).mean, 0
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0]).mean, 0
  end

  def test_variance
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0, 1, 2, 3]).variance, 1.25
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([-1, 1, 2, -2]).variance, 2.5
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0, 0]).variance, 0
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0]).variance, 0
  end

  def test_standard_deviation
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0, 1, 2, 3]).standard_deviation.truncate(5), 1.11803
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([-1, 1, 2, -2]).standard_deviation.truncate(5), 1.58113
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0, 0]).standard_deviation.truncate(5), 0
    assert_equal RubyTechnicalAnalysis::StatisticalMethods.new([0]).standard_deviation.truncate(5), 0
  end
  ...
  def test_bollinger_bands
    ...
    assert_equal RubyTechnicalAnalysis::BollingerBands.call(series_one, 5), [32.397, 32.062, 31.727]
    assert_equal RubyTechnicalAnalysis::BollingerBands.call(series_two, 5), [32.508, 32.15, 31.791]
  end
  ...
  def test_chaikin_money_flow
    ...
    assert_equal RubyTechnicalAnalysis::ChaikinMoneyFlow.call(hlcv_series_one, 5).truncate(5), 0.50786
    assert_equal RubyTechnicalAnalysis::ChaikinMoneyFlow.call(hlcv_series_two, 5).truncate(5), 0.22763
  end
  ...
  def test_chande_momentum_oscillator
    ...
    assert_equal RubyTechnicalAnalysis::ChandeMomentumOscillator.call(series_one, 5).truncate(4), 45.7143
    assert_equal RubyTechnicalAnalysis::ChandeMomentumOscillator.call(series_two, 5).truncate(4), 88.7324
    assert_equal RubyTechnicalAnalysis::ChandeMomentumOscillator.call(series_three, 5).truncate(4), 42.2222
    assert_equal RubyTechnicalAnalysis::ChandeMomentumOscillator.call(series_four, 5).truncate(4), -13.5135
  end
  ...
  def test_commodity_channel_index
    ...
    assert_equal RubyTechnicalAnalysis::CommodityChannelIndex.call(hlc_series_one, 5).truncate(4), 18.0890
    assert_equal RubyTechnicalAnalysis::CommodityChannelIndex.call(hlc_series_two, 5).truncate(4), 84.4605
  end
  ...
  def test_envelopes_ema
    ...
    assert_equal RubyTechnicalAnalysis::EnvelopesEma.call(series_one, 5, 20), [29.637, 24.698, 19.758]
    assert_equal RubyTechnicalAnalysis::EnvelopesEma.call(series_two, 5, 20), [29.588, 24.657, 19.725]
  end
  ...
  def test_intraday_momentum_index
    ...
    assert_equal RubyTechnicalAnalysis::IntradayMomentumIndex.call(oc_series_one, 7), 19.9880
    assert_equal RubyTechnicalAnalysis::IntradayMomentumIndex.call(oc_series_two, 7), 61.5228
  end
  ...
  def test_macd
    ...
    assert_equal RubyTechnicalAnalysis::Macd.call(series_one), [-1.934, -1.664, -0.27]
    assert_equal RubyTechnicalAnalysis::Macd.call(series_one, 12, 26, 9), [-1.934, -1.664, -0.27]
  end
  ...
  def test_mass_index
    ...
    assert_equal RubyTechnicalAnalysis::MassIndex.call(hl_series_one, 9), 3.2236
    assert_equal RubyTechnicalAnalysis::MassIndex.call(hl_series_two, 9), 3.1387
  end

  def test_pivot_points
    series_one = [176.65, 152.00, 165.12]

    assert_equal RubyTechnicalAnalysis::PivotPoints.call(series_one), [127.88, 139.94, 152.53, 164.59, 177.18, 189.24, 201.83]
  end
  ...
  def test_price_channel
    ...
    assert_equal RubyTechnicalAnalysis::PriceChannel.call(hl_series_one, 5), [2.9740, 2.8127]
  ...
  def test_qstick
    ...
    assert_equal RubyTechnicalAnalysis::QStick.call(oc_series_one, 4), 0.7969
    assert_equal RubyTechnicalAnalysis::QStick.call(oc_series_two, 4), 0.4688
  end
  ...
  def test_rate_of_change
    ...
    assert_equal RubyTechnicalAnalysis::RateOfChange.call(series_one, 3), -8.99
    assert_equal RubyTechnicalAnalysis::RateOfChange.call(series_two, 3), -4.94
  end
  ...
  def test_relative_momentum_index
    ...
    assert_equal RubyTechnicalAnalysis::RelativeMomentumIndex.call(series_one, 4, 8), 13.1179
    assert_equal RubyTechnicalAnalysis::RelativeMomentumIndex.call(series_two, 4, 8), 17.7112
  end
  ...
  def test_relative_strength_index
    ...
    assert_equal RubyTechnicalAnalysis::RelativeStrengthIndex.call(series_one, 5), 76.6667
    assert_equal RubyTechnicalAnalysis::RelativeStrengthIndex.call(series_two, 5), 78.8679
  end
  ...
  def test_stochastic_oscillator
    ...
    assert_equal RubyTechnicalAnalysis::StochasticOscillator.call(hlc_series_one, 5, 3, 3), 55.4100
    assert_equal RubyTechnicalAnalysis::StochasticOscillator.call(hlc_series_two, 5, 3, 3), 70.7715
  end
  ...
  def test_volume_oscillator
    ...
    assert_equal RubyTechnicalAnalysis::VolumeOscillator.call(series_one, 2, 5), -24.88
    assert_equal RubyTechnicalAnalysis::VolumeOscillator.call(series_two, 2, 5), -19.73
  end
  ...
  def test_volume_rate_of_change
    ...
    assert_equal RubyTechnicalAnalysis::VolumeRateOfChange.call(series_one, 5), 113.1253
    assert_equal RubyTechnicalAnalysis::VolumeRateOfChange.call(series_two, 5), 21.9165
  end
  ...
  def test_wilders_smoothing
    ...
    assert_equal RubyTechnicalAnalysis::WildersSmoothing.call(series_one, 5).truncate(4), 63.0675
    assert_equal RubyTechnicalAnalysis::WildersSmoothing.call(series_two, 5).truncate(4), 63.0540
  end
  ...
  def test_williams_percent_r
    ...
    assert_equal RubyTechnicalAnalysis::WilliamsPercentR.call(hlc_series_one, 5), 0
    assert_equal RubyTechnicalAnalysis::WilliamsPercentR.call(hlc_series_two, 5), -1.68
  end
end
