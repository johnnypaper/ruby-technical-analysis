...
class TestRubyTechnicalAnalysis < Minitest::Test
  ...
  def test_relative_momentum_index
    ...
    assert_equal RTA::RelativeMomentumIndex.new(case_one, 4, 8).call, 13.1179
    assert_equal RTA::RelativeMomentumIndex.new(case_two, 4, 8).call, 17.7112
  end
  ...
  def test_relative_strength_index
    ...
    assert_equal RTA::RelativeStrengthIndex.new(case_one, 5).call, 76.6667
    assert_equal RTA::RelativeStrengthIndex.new(case_two, 5).call, 78.8679
  end
  ...
  def test_stochastic_oscillator
    ...
    assert_equal RTA::StochasticOscillator.new(case_one, 5, 3, 3).call, 55.4100
    assert_equal RTA::StochasticOscillator.new(case_two, 5, 3, 3).call, 70.7715
  end
